...
import ui_connectNodesWidget
import models

class connectNodesWidget(QDockWidget, ui_connectNodesWidget.Ui_DockWidget):

    def __init__(self, parent=None):
        super(connectNodesWidget, self).__init__(parent)
        self.setupUi(self)
        self.inNodeComboBox.setModel(parent.nodeNameModel)
        self.outNodeComboBox.setModel(parent.nodeNameModel)
        self.mw = parent
        self.updateComboBox()
