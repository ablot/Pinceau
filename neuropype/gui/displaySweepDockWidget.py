...
import ui_displaySweepDockWidget

import setscaledialog, setRangeDlg
from numpy import random
import neuropype.ressources.progressbar as pgb

class displaySweepDockWidget(QDockWidget, ui_displaySweepDockWidget.Ui_DockWidget):

    def __init__(self, parent=None):
        super(displaySweepDockWidget, self).__init__(parent)
        self.setupUi(self)
        self.setWindowTitle('Display sweep')
        self.mw = parent
        self.updateNode()
        self.updateSweep()
