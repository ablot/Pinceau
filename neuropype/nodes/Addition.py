...
class Addition(node.Node):
    '''Add trace1 to trace0 (out = trace0 + trace1)
    ...
    if the channel to add is different from the channel added, 
    change params['chan_added']
    ...
    def __init__(self, name, parent):
        ...
        super(Addition, self).__init__(name, parent)
    ...
    def origin(self, index_sweep):
        ...
        return [in_ori, ['plus'].append(sub_ori)]
